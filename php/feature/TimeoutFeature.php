...
// FreeMusicApi2 SDK timeout feature
...
class FreeMusicApi2TimeoutFeature extends FreeMusicApi2BaseFeature
{
    ...
    private function _with_timeout(FreeMusicApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeMusicApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
