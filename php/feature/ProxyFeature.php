...
// FreeMusicApi2 SDK proxy feature
...
class FreeMusicApi2ProxyFeature extends FreeMusicApi2BaseFeature
{
    ...
    public function init(FreeMusicApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeMusicApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
