...
// FreeMusicApi2 SDK netsim feature
...
class FreeMusicApi2NetsimFeature extends FreeMusicApi2BaseFeature
{
    ...
    private function _simulate(FreeMusicApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeMusicApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
