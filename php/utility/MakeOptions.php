...
// FreeMusicApi2 SDK utility: make_options

class FreeMusicApi2MakeOptions
{
    ...
    public static function call(FreeMusicApi2Context $ctx): array
    {
        ...
        //
        // `FreeMusicApi2Schema::optspec()` is built from the model:
        ...
        $optspec = FreeMusicApi2Schema::optspec();
