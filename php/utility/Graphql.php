...
// FreeMusicApi2 SDK utility: graphql
//
...
class FreeMusicApi2Graphql
{
    ...
    // equivalent.
    public static function body(FreeMusicApi2Context $ctx): mixed
    {
    ...
    public static function errors(FreeMusicApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
