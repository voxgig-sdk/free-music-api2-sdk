...
// FreeMusicApi2 SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FreeMusicApi2TransformResponse
{
    public static function call(FreeMusicApi2Context $ctx): mixed
    {
        ...
        $transform = FreeMusicApi2Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
