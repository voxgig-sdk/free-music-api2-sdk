...
// FreeMusicApi2 SDK utility type

class FreeMusicApi2Utility
{
    ...
    public static function copy(FreeMusicApi2Utility $src): FreeMusicApi2Utility
    {
        $u = new FreeMusicApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
