...
// FreeMusicApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeMusicApi2SDK::test)
...
{
    private const SDK_CLASS = 'FreeMusicApi2SDK';
    ...
    private const SDK_BASE = 'freemusicapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freemusicapi2_sdk.php';
