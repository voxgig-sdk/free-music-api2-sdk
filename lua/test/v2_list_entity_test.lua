...
describe("V2ListEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FREEMUSICAPI__TEST_V__LIST_ENTID JSON to run live")
      return
    end
...
function v2_list_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FREEMUSICAPI__TEST_V__LIST_ENTID")
