...
function runner.env_override(m)
  local live = runner.getenv("FREEMUSICAPI2_TEST_LIVE")
  local override = runner.getenv("FREEMUSICAPI2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREEMUSICAPI2_TEST_EXPLAIN")
