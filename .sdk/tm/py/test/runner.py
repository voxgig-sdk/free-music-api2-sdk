...
class FreeMusicApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMusicApi2TestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FreeMusicApi2TestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FreeMusicApi2TestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
