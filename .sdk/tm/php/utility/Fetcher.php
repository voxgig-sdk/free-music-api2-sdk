...
// FreeMusicApi2 SDK utility: fetcher

class FreeMusicApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeMusicApi2SDK/1.0)';
    ...
    public static function call(FreeMusicApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
