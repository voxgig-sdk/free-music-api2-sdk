...
// FreeMusicApi2 SDK cache feature
...
class FreeMusicApi2CacheFeature extends FreeMusicApi2BaseFeature
{
    ...
    private function _through(FreeMusicApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
