...
// FreeMusicApi2 SDK ratelimit feature
...
class FreeMusicApi2RatelimitFeature extends FreeMusicApi2BaseFeature
{
    ...
    private function _acquire(FreeMusicApi2Context $ctx): void
    {
    ...
    private function _track(FreeMusicApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
