...
// FreeMusicApi2 SDK audit feature
...
class FreeMusicApi2AuditFeature extends FreeMusicApi2BaseFeature
{
    ...
    private function _emit(FreeMusicApi2Context $ctx, string $outcome): void
    {
