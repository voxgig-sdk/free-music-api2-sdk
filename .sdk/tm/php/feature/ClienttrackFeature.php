...
// FreeMusicApi2 SDK clienttrack feature
...
class FreeMusicApi2ClienttrackFeature extends FreeMusicApi2BaseFeature
{
    ...
    public function PostConstruct(FreeMusicApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeMusicApi2-SDK';
