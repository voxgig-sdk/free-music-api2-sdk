...
// FreeMusicApi2 SDK rbac feature
...
class FreeMusicApi2RbacFeature extends FreeMusicApi2BaseFeature
{
    ...
    private function _required(FreeMusicApi2Context $ctx): ?string
    {
    ...
    private function _reject(FreeMusicApi2Context $ctx, string $required): void
    {
    ...
    private function _track(FreeMusicApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
