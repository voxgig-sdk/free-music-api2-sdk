...
// FreeMusicApi2 SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FreeMusicApi2Omni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FreeMusicApi2Omni::structfix($now, Struct::undef()))
                        !== json_encode(FreeMusicApi2Omni::structfix($val, Struct::undef()))) {
