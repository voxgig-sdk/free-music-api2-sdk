...
describe('exists', async () => {
  ...
  //
  // FreeMusicApi2SDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof FreeMusicApi2SDK, true,
      'FreeMusicApi2SDK.test() must return a client synchronously')
  })
