...
import (
	...
	vs "github.com/voxgig-sdk/free-music-api2-sdk/go/utility/struct"
)

type FreeMusicApi2SDK struct {
	Mode     string
...
func (sdk *FreeMusicApi2SDK) OptionsMap() map[string]any {
...
func (sdk *FreeMusicApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FreeMusicApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FreeMusicApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeMusicApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FreeMusicApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FreeMusicApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FreeMusicApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FreeMusicApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeMusicApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FreeMusicApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *FreeMusicApi2SDK) V1List(data map[string]any) FreeMusicApi2Entity {
...
func (sdk *FreeMusicApi2SDK) V1Lookup(data map[string]any) FreeMusicApi2Entity {
...
func (sdk *FreeMusicApi2SDK) V1Search(data map[string]any) FreeMusicApi2Entity {
...
func (sdk *FreeMusicApi2SDK) V2List(data map[string]any) FreeMusicApi2Entity {
...
func (sdk *FreeMusicApi2SDK) V2Lookup(data map[string]any) FreeMusicApi2Entity {
...
func (sdk *FreeMusicApi2SDK) V2Search(data map[string]any) FreeMusicApi2Entity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FreeMusicApi2SDK {
	...
	sdk := NewFreeMusicApi2SDK(sdkopts)
	sdk.Mode = "test"
