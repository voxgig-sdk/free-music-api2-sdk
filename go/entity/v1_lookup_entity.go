...
func NewV1LookupEntity(client *core.FreeMusicApi2SDK, entopts map[string]any) *V1LookupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V1LookupEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
