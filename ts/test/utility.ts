...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.FREEMUSICAPI2_TEST_LIVE ||
    'TRUE' === process.env.FREEMUSICAPI2_TEST_OVERRIDE
  ) {
  ...
  m.FREEMUSICAPI2_TEST_EXPLAIN = process.env.FREEMUSICAPI2_TEST_EXPLAIN || m.FREEMUSICAPI2_TEST_EXPLAIN
