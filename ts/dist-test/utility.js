...
function envOverride(m) {
    if ('TRUE' === process.env.FREE_MUSIC_API2_TEST_LIVE ||
        'TRUE' === process.env.FREE_MUSIC_API2_TEST_OVERRIDE) {
    ...
    m.FREE_MUSIC_API2_TEST_EXPLAIN = process.env.FREE_MUSIC_API2_TEST_EXPLAIN || m.FREE_MUSIC_API2_TEST_EXPLAIN;
    return m;
}
