...
The Free Music API by TheAudioDB provides access to various music-related data, including artist details, album information, track listings, and music charts.

Learn more about Free Music API at [www.theaudiodb.com/free_music_api](https://www.theaudiodb.com/free_music_api).
...
const items = await client.V1List().list({ country: "example", format: "example", type: "example" })
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-music-api2-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-api2-sdk/releases) |
| Python | `voxgig-sdk-free-music-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-api2-sdk/releases) |
| PHP | `voxgig-sdk/free-music-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-api2-sdk/releases) |
| Golang | `github.com/voxgig-sdk/free-music-api2-sdk/go` | `go get github.com/voxgig-sdk/free-music-api2-sdk/go@latest` |
| Ruby | `voxgig-sdk-free-music-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-api2-sdk/releases) |
| Lua | `voxgig-sdk-free-music-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-api2-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/free-music-api2-sdk/go-cli` | `go install github.com/voxgig-sdk/free-music-api2-sdk/go-cli/cmd/free-music-api2@latest` |
| Go MCP server | `github.com/voxgig-sdk/free-music-api2-sdk/go-mcp` | `go get github.com/voxgig-sdk/free-music-api2-sdk/go-mcp@latest` |
...
v2List, err := client.V2List(nil).Load(
    map[string]any{"artist_id": 1}, nil,
)
if err != nil {
    panic(err)
}
