// Command FreeMusicApi2-cli is a CLI + REPL for the FreeMusicApi2 SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      FREE_MUSIC_API2_APIKEY (api key), FREE_MUSIC_API2_BASE (base url override)")
