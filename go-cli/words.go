...
func registerSDKWords(r *eng.Registry, client *sdk.FreeMusicApi2SDK) {
...
func runOp(client *sdk.FreeMusicApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
