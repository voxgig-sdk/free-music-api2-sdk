...
from freemusicapi2_sdk.core.control import FreeMusicApi2Control
...
from freemusicapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class FreeMusicApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FreeMusicApi2Control()
        ...
        if isinstance(sp, FreeMusicApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeMusicApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeMusicApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeMusicApi2Error(code, msg, self)
