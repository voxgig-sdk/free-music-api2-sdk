...
from freemusicapi2_sdk.utility import register

# Load features
from freemusicapi2_sdk.feature.base_feature import FreeMusicApi2BaseFeature
from freemusicapi2_sdk.features import _has_feature, _make_feature


class FreeMusicApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreeMusicApi2Utility()
        self._utility = utility

        from freemusicapi2_sdk.config import shared_config
    ...
    def get_utility(self):
        return FreeMusicApi2Utility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "FreeMusicApi2SDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeMusicApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def V1List(self, data=None) -> "V1ListEntity":
        ...
        from freemusicapi2_sdk.entity.v1_list_entity import V1ListEntity
    ...
    def V1Lookup(self, data=None) -> "V1LookupEntity":
        ...
        from freemusicapi2_sdk.entity.v1_lookup_entity import V1LookupEntity
    ...
    def V1Search(self, data=None) -> "V1SearchEntity":
        ...
        from freemusicapi2_sdk.entity.v1_search_entity import V1SearchEntity
    ...
    def V2List(self, data=None) -> "V2ListEntity":
        ...
        from freemusicapi2_sdk.entity.v2_list_entity import V2ListEntity
    ...
    def V2Lookup(self, data=None) -> "V2LookupEntity":
        ...
        from freemusicapi2_sdk.entity.v2_lookup_entity import V2LookupEntity
    ...
    def V2Search(self, data=None) -> "V2SearchEntity":
        ...
        from freemusicapi2_sdk.entity.v2_search_entity import V2SearchEntity
        return V2SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FreeMusicApi2SDK":
        if sdkopts is None:
            sdkopts = {}
