# FreeMusicApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeMusicApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeMusicApi2SDK(...) and FreeMusicApi2SDK.test(...) become
#      FreeMusicApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freemusicapi2_sdk"
_SDK_CLASS = "FreeMusicApi2SDK"
