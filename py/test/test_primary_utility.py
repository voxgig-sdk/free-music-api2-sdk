...
from freemusicapi2_sdk.core.spec import FreeMusicApi2Spec
from freemusicapi2_sdk.core.result import FreeMusicApi2Result
from freemusicapi2_sdk.core.response import FreeMusicApi2Response
from freemusicapi2_sdk.core.operation import FreeMusicApi2Operation
from freemusicapi2_sdk.core.error import FreeMusicApi2Error
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FreeMusicApi2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except FreeMusicApi2Error as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = FreeMusicApi2Result({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = FreeMusicApi2SDK.test(None, None)
        ...
        class TestInitFeature(FreeMusicApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FreeMusicApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = FreeMusicApi2SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FreeMusicApi2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FreeMusicApi2SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = FreeMusicApi2Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FreeMusicApi2SDK.test(None, setup_opts)
