...
class V2SearchEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FREE_MUSIC_API2_TEST_V2_SEARCH_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def v2_search_basic_setup(extra)
  ...
  entid_env_raw = ENV["FREE_MUSIC_API2_TEST_V2_SEARCH_ENTID"]
