...
#      offline in seeded test mode (FreeMusicApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FreeMusicApi2_sdk.rb")
  SDK_CLASS = "FreeMusicApi2SDK"
