...
require_relative 'FreeMusicApi2_types'
...
class FreeMusicApi2SDK
  ...
  def get_utility
    FreeMusicApi2Utility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = FreeMusicApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = FreeMusicApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = FreeMusicApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = FreeMusicApi2Helpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = FreeMusicApi2Error.new(
        "graphql_error", "FreeMusicApi2SDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = FreeMusicApi2SDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
